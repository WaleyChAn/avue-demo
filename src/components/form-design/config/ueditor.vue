    ...
    <div class="el-form-item el-form-item--small el-form--label-top">
      <label class="el-form-item__label" style="padding: 0">
        <el-link
          ...
          target="_blank"
          >参数设置 <i class="el-icon-question"></i
        ></el-link>
      </label>
      <div class="el-form-item__content">
        返回的数据结构层次
        <el-input
          v-model="data.options.props.res"
          size="small"
          placeholder="返回的数据结构层次"
        ></el-input>
        返回结构体图片地址字段
        <el-input
          v-model="data.options.props.url"
          size="small"
    ...
    <template v-if="data.options.oss == 'qiniu'">
      <div class="el-form-item el-form-item--small el-form--label-top">
        ...
        <div class="el-form-item__content">
          ...
          scope：
          <el-input
            v-model="data.options.qiniu.scope"
            size="small"
            clearable
          ...
          url：
          <el-input
            v-model="data.options.qiniu.url"
            size="small"
            clearable
          ...
          deadline：
          <el-input
            v-model="data.options.qiniu.deadline"
            size="small"
            clearable
    ...
    <template v-if="data.options.oss == 'ali'">
      <div class="el-form-item el-form-item--small el-form--label-top">
        ...
        <div class="el-form-item__content">
          region：
          <el-input
            v-model="data.options.ali.region"
            size="small"
            clearable
            placeholder="region"
          ></el-input>
          endpoint：
          <el-input
            v-model="data.options.ali.endpoint"
            size="small"
            clearable
          ...
          accessKeyId：
          <el-input
            v-model="data.options.ali.accessKeyId"
            size="small"
            clearable
          ...
          accessKeySecret：
          <el-input
            v-model="data.options.ali.accessKeySecret"
            size="small"
            clearable
          ...
          bucket：
          <el-input
            v-model="data.options.ali.bucket"
            size="small"
            clearable
            placeholder="bucket	"
          ></el-input>
